...
- **Status:** IN_PROGRESS (registered 2026-09-21 before the fix per §13; the diagnosis leg is COMPLETE with live evidence — see below)
...
- **Left:** the apply + GREEN legs + the closeout commits (this session).
- **Next:** the closeout (same session) — then OPS-319's restore-surface task / T-337 (REALTIME-105).
- **Commit:** (this session's registration commit — see change-log).
