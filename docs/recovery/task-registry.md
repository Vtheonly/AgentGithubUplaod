...
- **Status:** IN PROGRESS (registered 2026-09-21 — 81st session)
- **Problems:** OPS-320 (registered BEFORE the fix per §13); PERF-501 evidence probe delivered as the first leg
...
- **Status:** OPEN (registered 2026-09-21 — 81st session; starts after T-396's runner can verify the fix)
- **Problems:** PERF-501, DATA-019 (both registered BEFORE the fix per §13)
