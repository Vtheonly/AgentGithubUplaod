...
## T-416 — The Purge Button: the canonical student/parent domain reset (issue #12) — IN_PROGRESS (P0)
...
**Related:** issue #12 (GitHub) · PURGE-500 / PURGE-501 · T-415 (the sync/backup hardening this task must not disturb — BKUP-501..507, SYNC-108/109/111) · migration 0100 (the soft-delete RPC house pattern) · ADR-027 (the purge contract) · the unregistered live migration 0118 (the overload-reconciliation hazard, PURGE-500)
