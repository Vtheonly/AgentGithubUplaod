...
- **Status:** IN PROGRESS (registered at session OPEN, 2026-09-14, BEFORE the fix per §13 — REGISTERED AS T-371 LOCALLY, RENUMBERED T-372 at merge time: the concurrent session registered its own T-371 on the shared remote first (commit 942d3a2); the migration renumber follows: THIS task takes 0098, their WORKFORCE-501 takes 0097)
