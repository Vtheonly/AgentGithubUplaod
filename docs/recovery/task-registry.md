...
- **Status:** IN PROGRESS (opened 2026-09-17; the tooling + guard landed first, then per-area migration iterations)
...
- **Left:** everything except the tooling at open — see the burn-down list in src/test/t-385-i18n-coverage.test.ts (the authoritative progress tracker).
- **Next:** T-385 iterations (this task).
