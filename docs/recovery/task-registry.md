...
- **Left:** the LIVE re-verification leg only — it runs with T-393's diagnostics runner against the NEW project (same session).
...
- **Left:** implementation + tests (this session).
