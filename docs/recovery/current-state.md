...
- **2026-08-31 — Thirteenth repair session (IN PROGRESS; owner-requested ~10-task batch):** portal `.env.local` configured (the "Missing configuration" banner is GONE — live headless render verified); mandatory live chain check 57/57 (0001–0060); **T-041 TESTED** (migration 0059 live 10/10 — canonical atomic year-end promotion; desktop 64 files / 2146 tests); **T-030 TESTED** (migration 0060 live 9/9 — FCM transfer guard + unregister RPC; website 14 files / 135 tests); NEW problem AUTH-200 registered (Google OAuth provider disabled on the live project — owner action required, runbook in docs/operations/portal-google-oauth.md). Remaining batch: T-058, T-050, T-036 (PUSH-103 portion), T-026, T-054, T-062, T-063, T-064.
