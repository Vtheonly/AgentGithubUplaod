...
- **Status:** OPEN — registered BEFORE the fix (T-343, 2026-09-14); fix tasks T-344 (DB migration 0094 + live apply), T-345 (desktop domain + resolver), T-346 (desktop UI), T-347 (website sync), T-348 (Android mirror), T-349 (closeout).
