...
describe("Sequence: cross-platform complete workflow", () => {
  it("desktop and mirror produce identical final state for a complete enrollment + payment workflow", () => {
    ...
    const desktopEntries = [
      { id: "c1", tenantId: "t1", accountId: "parent:par-001:category:tuition:student:stu-001", parentId: "par-001", studentId: "stu-001", category: "tuition", amount: dSplit[0], type: "charge" as const, sourceType: "installment" as const, sourceId: "ins-c1", method: null, receiptNumber: null, paymentStatus: null, reversesId: null, description: "Charge", actorId: "u1", actorName: "Alice", at: "2026-09-15T00:00:00Z", metadata: {} },
      { id: "c2", tenantId: "t1", accountId: "parent:par-001:category:tuition:student:stu-001", parentId: "par-001", studentId: "stu-001", category: "tuition", amount: dSplit[1], type: "charge" as const, sourceType: "installment" as const, sourceId: "ins-c2", method: null, receiptNumber: null, paymentStatus: null, reversesId: null, description: "Charge", actorId: "u1", actorName: "Alice", at: "2026-12-15T00:00:00Z", metadata: {} },
      { id: "c3", tenantId: "t1", accountId: "parent:par-001:category:tuition:student:stu-001", parentId: "par-001", studentId: "stu-001", category: "tuition", amount: dSplit[2], type: "charge" as const, sourceType: "installment" as const, sourceId: "ins-c3", method: null, receiptNumber: null, paymentStatus: null, reversesId: null, description: "Charge", actorId: "u1", actorName: "Alice", at: "2027-03-15T00:00:00Z", metadata: {} },
      { id: "p1", tenantId: "t1", accountId: "parent:par-001:category:tuition:student:stu-001", parentId: "par-001", studentId: "stu-001", category: "tuition", amount: -dSplit[0], type: "payment" as const, sourceType: "payment" as const, sourceId: "pay-p1", method: "cash" as const, receiptNumber: "REC-p1", paymentStatus: "paid" as const, reversesId: null, description: "Payment", actorId: "u1", actorName: "Alice", at: "2026-09-20T10:00:00Z", metadata: {} },
    ];
