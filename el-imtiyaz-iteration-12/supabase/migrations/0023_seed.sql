...
comment on script is 'Reference seed data: 1 default tenant, 11 roles, 56 permissions, full role-permission matrix, 14 academic levels, 2026-2027 academic year, 9 expense categories, 4 departments, full pricing config with 14 tuitions + 4 transports + 3 services + 5 discounts.';
