...
### 44. **A composite RPC's parameter set must be RE-AUDITED whenever the inner canonical function gains params — and UI sentinels must be REAL option values (T-407 / ACAD-504, 2026-09-22)**
